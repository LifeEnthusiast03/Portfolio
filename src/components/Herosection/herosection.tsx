...
import {
  ...
  Cpu, Server, GitBranch, LucideIcon
} from 'lucide-react';
...
/* ─── Typewriter hook ───────────────────────────────── */
function useTypewriter(words: string[], typingSpeed = 80, pauseMs = 1800, deleteSpeed = 45) {
  ...
  return (
    <>
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 overflow-hidden bg-transparent pt-24">
        ...
        <motion.div className="relative z-10 max-w-7xl mx-auto w-full" variants={container} initial="hidden" animate="show">
          <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center">
            ...
            <div className="text-center lg:text-left order-2 lg:order-1">
              ...
              <motion.h1 variants={item} className="text-5xl sm:text-6xl lg:text-7xl xl:text-[80px] font-black mb-4 leading-[1.05] tracking-tight">
                ...
                <span className="relative">
                  <span className="bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-500 bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Sougata</span>
                ...
                <br />
                <span className="bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-500 bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Saha</span>
              </motion.h1>
              ...
              <motion.div variants={item} className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mb-10">
                <Link to="/projects" className="group relative inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl overflow-hidden transition-all duration-300 shadow-[0_0_30px_rgba(37,99,235,0.4)] hover:shadow-[0_0_40px_rgba(59,130,246,0.55)]">
                  <Rocket size={18} />
                  View Projects
                  <ArrowUpRight size={15} className="transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                </Link>
                <button onClick={handleDownloadCV} className="group inline-flex items-center justify-center gap-2 px-7 py-3.5 border border-gray-700 hover:border-blue-500/50 text-gray-300 hover:text-white font-semibold rounded-xl transition-all duration-300 backdrop-blur-sm hover:bg-blue-950/40 hover:shadow-[0_0_24px_rgba(37,99,235,0.2)]">
                  <Download size={18} />
                  Download CV
                </button>
              </motion.div>
            ...
            {/* RIGHT — profile */}
            <motion.div className="order-1 lg:order-2 flex justify-center lg:justify-end"
              ...
              <div className="relative">
                ...
                <div className="relative w-72 h-72 sm:w-[340px] sm:h-[340px] lg:w-[400px] lg:h-[400px]">
                  <div className="absolute inset-0 rounded-full animate-spin" style={{ animationDuration: '8s', background: 'conic-gradient(from 0deg, #3b82f6, #06b6d4, #8b5cf6, #3b82f6)', padding: '2px' }}>
                  ...
                  <div className="absolute inset-4 rounded-full overflow-hidden shadow-2xl">
                    <img src="./sougata.jpg" alt="Sougata Saha" className="w-full h-full object-cover" />
      ...
      <section className="relative py-28 px-4 sm:px-6 bg-transparent">
        <motion.div className="max-w-6xl mx-auto relative z-10"
          ...
          viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] as [number, number, number, number] }}>
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mb-20">
            {STATS.map((s, i) => (
              <motion.div key={i}
                ...
                transition={{ delay: i * 0.1 + 0.1 }} whileHover={{ scale: 1.04, transition: { duration: 0.2 } }}>
          ...
          <div className="grid lg:grid-cols-5 gap-10 items-start">
            <motion.div className="lg:col-span-2" initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }}
              ...
              <p className="text-gray-300 text-base leading-relaxed mb-5">
                ...
                pursuing Information Technology. I love building modern web applications and exploring Generative AI technologies.
              </p>
              ...
              <Link to="/skills" className="group inline-flex items-center gap-2 px-5 py-3 bg-blue-950/50 border border-blue-500/25 text-blue-300 rounded-xl hover:bg-blue-900/50 hover:border-blue-400/40 hover:text-white transition-all duration-300 font-medium text-sm">
                <Code size={16} />
                View My Skills
            ...
            <motion.div className="lg:col-span-3 grid grid-cols-2 gap-4" initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }} transition={{ duration: 0.65, ease: [0.22, 1, 0.36, 1] as [number, number, number, number] }}>
              {TECH_CARDS.map((card, i) => (
                <motion.div key={i}
                  ...
                  transition={{ delay: i * 0.08 + 0.2 }} whileHover={{ scale: 1.03, transition: { duration: 0.2 } }}>
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl" style={{ boxShadow: `inset 0 0 40px ${card.glow}` }} />
