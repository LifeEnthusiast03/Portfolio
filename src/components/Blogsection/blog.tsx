...
import {
  ...
  Calendar, Eye, Heart, Rss, ChevronRight
} from 'lucide-react';
...
const BlogSection = () => {
  ...
  return (
    <>
      <BlogReader post={activeBlog} onClose={() => setActiveBlog(null)} />
      ...
      <section className="min-h-screen py-28 px-4 sm:px-6 lg:px-8 bg-transparent relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <motion.div className="mb-12" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15, duration: 0.6 }}>
            <div
              className="group relative rounded-2xl overflow-hidden border border-gray-800/70 hover:border-purple-500/30 bg-black/40 backdrop-blur-xl transition-all duration-500 hover:shadow-[0_0_60px_rgba(168,85,247,0.12)] cursor-pointer"
            ...
            >
              ...
              <div className="relative p-8 md:p-10 flex flex-col md:flex-row gap-8 items-start">
                <div className="shrink-0 w-16 h-16 rounded-2xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
                  <featured.icon size={28} className="text-purple-400" />
                </div>
