...
import { Code, Palette, Database, Globe, Terminal, GitBranch, Monitor, Star, Zap, Package, Wifi, TestTube, Server, Folder, Github, Rocket, Paintbrush, Layout, Smartphone, Brain, Link2, Container, Cpu, Network, FileText, Box, Layers } from 'lucide-react';
...
const SkillCard = ({ skill, index, categoryColor }: SkillCardProps) => (
  <motion.div
...
const SkillsSection = () => {
  ...
  const skillCategories: SkillCategory[] = [
    {
      title: 'Programming Languages', icon: <Code className="w-6 h-6" />,
    ...
    {
      title: 'Frontend Development', icon: <Palette className="w-6 h-6" />,
    ...
    {
      title: 'Backend Development', icon: <Server className="w-6 h-6" />,
    ...
    {
      title: 'Database Management', icon: <Database className="w-6 h-6" />,
    ...
    {
      title: 'CS Fundamentals', icon: <Monitor className="w-6 h-6" />,
      color: 'from-cyan-500 to-teal-500', bgColor: 'bg-cyan-500/10',
      skills: [
    ...
    {
      title: 'Tools & Version Control', icon: <GitBranch className="w-6 h-6" />,
      color: 'from-pink-500 to-rose-500', bgColor: 'bg-pink-500/10',
      skills: [
    ...
    {
      title: 'GenAI Technology', icon: <Brain className="w-6 h-6" />,
      color: 'from-violet-500 to-purple-500', bgColor: 'bg-violet-500/10',
      skills: [
    ...
    {
      title: 'OS & Dev Environment', icon: <Terminal className="w-6 h-6" />,
      color: 'from-indigo-500 to-blue-500', bgColor: 'bg-indigo-500/10',
      skills: [
